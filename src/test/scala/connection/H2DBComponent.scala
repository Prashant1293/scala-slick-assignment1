...
trait H2DBComponent extends DbProvider{
  ...
  val h2Url = randomDB + "MODE=MySql;DATABASE_TO_UPPER=false;" +
    "INIT=RUNSCRIPT FROM 'app/test/resources/schema.sql'\\;" +
    "RUNSCRIPT FROM 'app/test/resources/initaldata.sql'"
